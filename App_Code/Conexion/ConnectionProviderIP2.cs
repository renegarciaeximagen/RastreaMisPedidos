...
// Generated by LLBLGen v1.21.2003.712 Final on: Jueves, 12 de Agosto de 2010, 02:49:59 p.m.
...
namespace Componente.ConexionIP2
{
	/// <summary>
	...
	public class ConnectionProvider : IDisposable
	{
		...
		private void InitClass()
		{
			...
			_dBConnection.ConnectionString = 
						_configReader.GetValue("Main.ConnectionStringIP2", typeof(string)).ToString();
			_isDisposed = false;
			_currentTransaction = null;
